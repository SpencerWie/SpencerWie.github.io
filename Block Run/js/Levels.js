var level_1 = [
    ...
    '#          o         o      E                  ______                                  ~ ######oo        ~    #',   
    '###        ~        ~      ########     ####              #####                          ######~   o o        #',   
    '######vvvvvvvvvvvvvvvvvvvvvv######vvvvvv####vvvvvvvvvvvv########                         ###### o o H o       #',   
    '#########################################################################################################vvvvv#', 
    '###############################################################################################################',    
 ];
 ...
 var level_3 = [
    ...
    '#             o o o                                                                                                                                   #   #        #                                                ',
    '#             o H o                                                                                                   o    vv    o                    #  o#        #                                                ',   
    '#S            o o o                                     o    oo     o                  o K o                         #### >##< ####S                  #  _#        #                                                ',   
    '######        ##### S                                 >##<  >##<  >##<               #########                 oo         >##<         oo                          #                      TTTT                      ',
    '#    #       #######           #     #    #            ^^    ^^    ^^               #         #               ___#         ^^         #___              o          #                                                ', 
    '#  D l   M  #########         ##vvvvv#vvvv#E     #vvvvvvvvvvvvvvvvvvvvvvvv#        #           #                 #vvvvvvvvvvvvvvvvvvvv#              #######       #vvvvvvvvvvvvvvvvvvvvvvvvvvvvv                   ',  
    '#____############################################################################################################################################################################################~                 ',    
    '#                                                                                                                                                  T                                     T                         ',
    '#                                                                                                                                                  T                                     T                         ',
    '#____                                                               k                                                                              T        S              S             T                          ',
    '#                                    T                              T                                                               T              T S                               S  kT                          ',
    '#                                                                              o                                                           T       T       ~        ~        ~         ~ T                          ',
    '#____                                        T              T                  T        T                                 o                        T            S                        T                          ',
    '#                                                                                               o                        TTT                      TT  ~   S                              T                         ',
    '#                                                    T                                          T                                                  T                 S                 S T                         ',
    '#____            oooo                                       oo      oo                                         o                           T       l      ~                                     STT                T',
    '#          T     TTTT                                       TT      TT                                T        T                                  TTT         ~       ~ S      ~       TTTTT     TT                T',
