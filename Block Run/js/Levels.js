var level_1 = [
    ...
    '#    __#####      ~      ~      ~                              ___              ###           #  ',
    '# o    ######                              o         E                           #            #  ',
    '#      ######vvvvvvvvvvvvvvvvvvvvvvvvv############vvv######                  o   L     P      #  ',   
    '#__   #########################################################################################  ',
    '#     ####                                                                               ######  ',
    '#   __##                                                                                 ######  ',
    '#                                                                       K                ######  ', 
    ...
    '#          o         o      E                  ______                                  ~ ######  ',   
    '###        ~        ~      ########     ####              #####                          ######  ',   
    '######vvvvvvvvvvvvvvvvvvvvvv######vvvvvv####vvvvvvvvvvvv########                         ######  ',   
    '###############################################################################################  ', 
    '###############################################################################################  ',    
 ];
 ...
 var level_2 = [
    ...
    '#    o   #######     ###     ###       o      ##         #         #######       o # o               #',
    '#           #         #       #       ###     #          #           >#<           L         ___     #',
    '#   ###     #         #       #vvvvvvvvvvvvvvv#   o o o  #           >#<        ___#___    vvvvvvvvvv#',
    '#    #      #         #      ##################          ######   o  >#<  o        #       ###########',
...
function loadImages() 
{
   ...
   images = {};
   var imgs = [
      "player_blink", "block", "coin", "heart", "background", "enemies", "portal", "boss_portal", "lock", "lock_silver", "key", "key_silver", "spikes", "platform", "falling_platform" , "enemy_spike", "shop_vendor", "shop_dialogs", "armor",
      "BigRed", "BigRed_Attack"
   ];
