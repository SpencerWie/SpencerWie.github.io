var level_1 = [
 ...
 var level_3 = [
    ...
    '######        ##### S                                 >##<  >##<  >##<               #########                 oo         >##<         oo                          #       TT       TTTT                            ',
    '#    #       #######           #     #    #            ^^    ^^    ^^               #         #               ___#         ^^         #___              o          ##vvvvvvvvvvvvvvvvvvvv                           ', 
    '#  D l   M  #########         ##vvvvv#vvvv#E     #vvvvvvvvvvvvvvvvvvvvvvvv#        #           #                 #vvvvvvvvvvvvvvvvvvvv#             ########################################~                       ',  
    '#____###############################################################################################################################################                                     T                          ',    
    '#                                                                                                                                                  T                                     T                          ',
    '#                                                                                                                                                  T                                     T                          ',
    '#____                                                                                                                                              T           S           S             T                          ',
    '#                                                                 k                   S                                            TT     oo       T S                                 SkT                          ',
    '#                                    T       o       S            T                                                                       TT       T       ~        ~        ~         ~ T                          ',
    '#____                                        T              T        S         T        T                          S      o                       TT                              S      T                          ',
    '#                                                                                                                        TTT                       T  ~   S                              T                          ',
    '#                                                    T                                          T             S                            TT      T                 S                 S T                   H      ',
    '#____            oooo                                       oo      oo                                         oo                                  l      ~                                     STT#S        TTTTTTT',
    '#         TT     TTTT                                       TT      TT                              TTS        TT                                 TTT         ~       ~ S      ~       TTTTTTTTTTTT#         T     T',
